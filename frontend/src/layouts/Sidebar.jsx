...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`
        bg-gray-900 text-white flex-shrink-0 flex flex-col
    ...
    >
      <div className="h-16 flex items-center px-4 border-b border-gray-700 flex-shrink-0">
        ...
        {!collapsed && (
          <span className="ml-3 font-semibold text-white truncate">AutoParts POS</span>
        )}
      </div>
      ...
      <nav className="flex-1 py-3 overflow-y-auto">
        {NAV.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 mx-2 px-3 py-2.5 rounded-lg text-sm transition-colors my-0.5
              ${isActive
